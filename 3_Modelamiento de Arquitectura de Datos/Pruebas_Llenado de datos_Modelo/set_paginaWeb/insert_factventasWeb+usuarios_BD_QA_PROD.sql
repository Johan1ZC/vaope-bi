...
-- select *
from vaope_qa4.products p
left join vaope_qa4.categories c on p.category_id = c.id;
...
-- select * from dwh_dev_3.dimeventos
...
d.id as ubigeo
from vaope_qa4.districts d
inner join vaope_qa4.provinces p on d.province_id = p.id
inner join vaope_qa4.departments dp on p.department_id = dp.id;
...
drop table vaope.dimOrganizadores;
...
drop table vaope.nroclics;
create table vaope.nroclics
SELECT product_id,sum(impression) nroClics FROM vaope_qa4.event_metrics
group by product_id;
...
select * from dwh_dev_3.dimfecha;
select * from dwh_dev_3.dimhora;
select * from dwh_dev_3.dimusuario;
select * from dwh_dev_3.factventasweb;


SELECT * FROM dwh_dev_3.dimeventos;
select * from dwh_dev_3.eventosorganizador_detalle;
select * from dwh_dev_3.dimorganizadores;

select * from dwh_dev_3.dimlocalevento;
select * from dwh_dev_3.dimubicacion;
