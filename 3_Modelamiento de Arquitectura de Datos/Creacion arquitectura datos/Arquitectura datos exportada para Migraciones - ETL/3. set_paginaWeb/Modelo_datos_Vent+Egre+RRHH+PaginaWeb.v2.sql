...
/* =======================================================================
   Huella: JZ-VAOPE-DW-SET_PAGINAWEB-002
   ...
   Dependencias: DimFecha, DimEventos, DimLocalEvento, DimUbicacion, DimOrganizadores,
   Dimticketera creadas peviamente - Privilegios CREATE/ALTER/INDEX.
   Descripción:
     - Crea dimensiones y hechos clave (Dimhora, DimUsuario, FactVentasWeb)
   ...
   Propósito:
     - Estandarizar el modelo estrella para la Pagina Web vinculados a Usuarios, Tiempo, Eventos,
       Organizadores, Locales del evento, Ubicaciones con claves de negocio y surrogate keys.
   ======================================================================= */
